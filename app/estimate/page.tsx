  ...
  return (
    <div className="h-full my-auto w-full flex gap-4 2xl:gap-6 justify-between">
      <div className="h-full w-[45%] flex flex-col gap-4 2xl:gap-6 rounded-2xl">
        <div className="px-6 py-5 2xl:px-8 2xl:py-7 rounded-2xl h-[20%] bg-white flex flex-col gap-6 items-center">
          {/* <ProjectTotals /> */}
        </div>
        <div className="px-8 py-5 2xl:px-8 2xl:py-7 rounded-2xl bg-white h-[80%]">
          <CreateEstimate />
        </div>
      </div>

      <div className="w-[55%] flex flex-col gap-6 justify-between">
        <div className="px-6 py-5 2xl:px-8 2xl:py-8 rounded-2xl h-[45%] bg-white flex flex-col gap-4 2xl:gap-6">
          ...
          <div className="text-[10px] 2xl:text-[14px] rounded-2xl bg-accent-50 drop-shadow-sm w-full h-[85%] py-2 pb-5 2xl:py-6 2xl:pb-10">
            {summaryLabels_1.map((label, index) => (
              <div
                key={label}
                className={`${
                  index % 2 === 1 ? "bg-textColor-100" : ""
                } w-[95%] mx-auto my-1.5 2xl:my-2`}
              >
            ...
            <div className="2xl:text-[14.5px] flex items-center w-[95%] justify-between mx-auto my-7 2xl:my-10">
        ...
        <div className="px-6 py-5 2xl:px-8 2xl:py-7 h-[55%] bg-white w-full rounded-2xl flex flex-col justify-between">

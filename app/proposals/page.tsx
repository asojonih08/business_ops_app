    ...
    <div className="w-full h-full bg-white px-12 py-12 2xl:px-0 2xl:py-0 p-6 rounded-2xl flex flex-col gap-10 items-center justify-center">
      ...
      <div className="flex w-full justify-center gap-[8%]">
        <div className="h-64 2xl:h-96 flex flex-col gap-4">
          <span className="font-semibold text-accent-800 text-[15px] 2xl:text-xl w-[300px] 2xl:w-[400px]">
            Choose Client
          </span>
          <ClientSelect />
        </div>
        <div className="flex flex-col gap-4 w-[540px] 2xl:w-[680px] ">
          <span className="font-semibold text-accent-800 text-[15px] 2xl:text-xl">
            Choose Project
          </span>
      ...
      <div className="w-full px-36 flex justify-center">
        <Button
          className="from-accent-100 to-accent-base/40 bg-gradient-to-r font-semibold text-accent-950 text-sm 2xl:text-lg w-[28%] 2xl:w-[30%] drop-shadow-md duration-500 px-0 py-0
